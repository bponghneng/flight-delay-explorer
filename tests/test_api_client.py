...
from flight_delay_explorer.models import QueryParams, FlightRecord, DelayCategory
...
class TestAviationStackClient:
    ...
    def test_get_flights_successful_request(self, mock_get, mock_settings, mock_logger, sample_api_response):
    ...
    @patch('httpx.Client.get')
    def test_get_flights_http_error_handling(self, mock_get, mock_settings, mock_logger):
    ...
    @patch('httpx.Client.get')
    def test_get_flights_network_error_handling(self, mock_get, mock_settings, mock_logger):
    ...
    @patch('httpx.Client.get')
    def test_get_flights_max_retries_exceeded(self, mock_get, mock_settings, mock_logger):
    ...
    @patch('httpx.Client.get')
    def test_get_flights_authentication_header(self, mock_get, mock_settings, mock_logger):
    ...
    @patch('httpx.Client.get')
    def test_get_flights_response_parsing(self, mock_get, mock_settings, mock_logger, sample_api_response):
    ...
    @patch('httpx.Client.get')
    def test_get_flights_rate_limit_handling(self, mock_get, mock_settings, mock_logger):
    ...
    @patch('httpx.Client.get')
    def test_get_flights_request_response_logging(self, mock_get, mock_settings, mock_logger, sample_api_response):
